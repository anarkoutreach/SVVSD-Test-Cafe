...
class LoginPage {
	...
	checkUsernameValidity = ClientFunction(() => {
	  const element = (document.querySelector('#userLogin') as HTMLSelectElement);
	  return element.checkValidity();
	})

	checkPasswordValidity = ClientFunction(() => {
	  const element = (document.querySelector('#userPassword') as HTMLSelectElement);
	  return element.checkValidity();
	})

	checkSubmitValidity = ClientFunction(() => {
	  const element = (document.querySelector('#submit') as HTMLSelectElement);
	  return element.checkValidity();
	})
